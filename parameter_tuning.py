...
"""
The goal of this script is to use unsupervised learning
solve anomaly detection in server logs.

1. OneHot encode the categorical features
2. create User defined function(UDF) in SparkSQL
3. extract anomalies from clustering result
4. tune parameters for unsupervised learning
